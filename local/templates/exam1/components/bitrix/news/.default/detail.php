...
<?/* <p><a href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>">111<?=GetMessage("T_NEWS_DETAIL_BACK")?></a></p> */?>
<p><a href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>" class="review-block_back_link"> &larr; <?=GetMessage("T_NEWS_DETAIL_BACK")?></a></p>
